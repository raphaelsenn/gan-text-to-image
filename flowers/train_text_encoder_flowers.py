...
from datasets.flowers102 import FlowersTextEnc, FlowersSampler
...
if __name__ == '__main__':
    ...
    # Load Flowers dataset (google/text-encoder version)
    dataset = FlowersTextEnc(ROOT_IMG_FEATURES, ROOT_CAP_DIR, CONTEXT_LENGTH)

    train_sampler = FlowersSampler(dataset, TRAIN_CLASSES, cfg.batch_size)
    val_sampler = FlowersSampler(dataset, VAL_CLASSES, 20)
